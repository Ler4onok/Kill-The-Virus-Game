...
},{"./..\\assets\\aim.cur":[["aim.84ac894f.cur","assets/aim.cur"],"assets/aim.cur"],"./..\\assets\\virus.svg":[["virus.35329740.svg","assets/virus.svg"],"assets/virus.svg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"utils/index.js":[function(require,module,exports) {
"use strict";
...
var VIRUSES_ELIMINATED = 0;
var VIRUSES_MISSED = 0;
...
function displayVirus(virus) {
  var gameInterval = setInterval(function () {
    ...
    if (isShown) {
      ...
      var virusPosY = (0, _utils.getRandomNumber)(0, _constants.MAP_HEIGHT - 50);
      var virusPosX = (0, _utils.getRandomNumber)(0, _constants.MAP_WIDTH - 50);
      virus.style.left = "".concat(virusPosX, "px");
...
initialize();
},{"./assets/map.png":"assets/map.png","./styles/index.css":"styles/index.css","./utils":"utils/index.js","./constants":"constants.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
